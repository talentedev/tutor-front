...
import {NewModalAlertComponent} from '../common/new-modal-alert/new-modal-alert.component';
...
export class AlertRef {
    constructor(private service: NewAlertService,
                private overlayRef: OverlayRef,
                private alertRef: NewModalAlertComponent) {
    }
...
export class NewAlertService {
    ...
    alert(title: string, message?: string, alertOptions?: AlertOptions): AlertRef {
        ...
        const componentRef: ComponentRef<NewModalAlertComponent> = overlayRef.attach(new ComponentPortal(NewModalAlertComponent));
